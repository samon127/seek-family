...
if ($defaultValue)
{
    $options = [$defaultValue=>Gllue::getProjectNameById($defaultValue)['jobTitle']];
}
else {
    $options = [];
}
echo HTML::dropDownList($page.'[gllue_project]', $defaultValue, $options, ['id' => 'gllueProjectSelect', 'class' => 'form-control']);
...
$('#gllueProjectSelect').select2({
	  ajax: {
		    //url: "https://api.github.com/search/repositories",
		    url: "<?php echo Url::to(['project/get-gllue-project']) ?>",
		    dataType: 'json',
		    delay: 250,
