...
<form class="form-horizontal" action="<?php echo Url::to(['income-account/submit']) ?>" method="post">
...
<div class="form-group">
  ...
  <div class="col-md-4">
    ...
    <?php if ($defaultValue) : ?>
    <a href="#" data-href="<?php echo Url::to(['income-account/delete', 'id'=>$defaultValue['id']]) ?>" class="btn btn-primary btn-danger" style="float:right" data-toggle="modal" data-target="#confirm-delete"><span class="glyphicon glyphicon-trash"></span> 删除</a>
    <?php endif; ?>
  </div>
</div>
